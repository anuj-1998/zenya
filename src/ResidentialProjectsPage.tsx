...
const residentialProjects = [
    ...
    },
    {
      ...
      <br>
      <p>Each suite comes with LED lighting to reduce electricity consumption, and double-glazed-tempered glass windows infilled with inert gas to reduce head gain while enjoying uncompromised views all-round. </p>
    `,
        reverse: false,
    },
    {
        ...
        text: `
        <p>The Brighton is Miri's first luxury condominium, located at Brighton next to the ParkcityEverly hotel, overlooking the Miri River and offering panoramic views of the South China Sea and its beautiful seaside sunsets. It was the first major development to strategically complement the Miri Resort City master plan.</p>
        <br>
        <p>The 20-storey condominium features major luxurious facilities which includes a clubhouse, gymnasium, tennis courts, adult & children's swimming pools, jogging tracks landscaped gardens and residents' parking bays.</p>
        `,
        reverse: false,
    }
];
